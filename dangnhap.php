<?php
    ...
    if(isset($_POST['btn'])){
        ...
        $sql = "select * from NguoiDung where IDNDung = '{$taikhoan}' and MatKhau =  '{$matkhau}'";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Thi trực tuyến</span>
                </a>
              </div><!-- End Logo -->
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method = "POST" novalidate >
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Please enter your Tài khoản!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="btn">Đăng nhập</button>
                    </div>
                    <div class="col-12">
