...
<?php
     ...
     if(isset($_POST['btn'])){
        ...
        $lophoc = $_POST['lophoc'];
        $mota = $_POST['mota'];
        $ssql = "update MonHoc set TenMonHoc = '$tenmonhoc', MoTa = '$mota' where IDMonHoc=".$id;
        mysqli_query($conn, $ssql);
        $ssql1 = "update MH_GV set IDMonHoc = '$monhoc', IDNDung = '$nguoidung', IDLop = '$lophoc' where IDMH_GV=".$this_id;
