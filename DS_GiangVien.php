...
<p>
  <a href="ThemGV.php" class="btn btn-success">
			...
			<div class="col-12">
				<div class="card recent-sales overflow-auto">
                  ...
                  <th class="col-2 text-center">Ảnh</th>
							...
							<tbody>
                <?php $sql = 'SELECT * FROM NguoiDung WHERE VaiTro like "Giáo Viên"';
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    <tr>
                      <th class="text-center" scope="row"><?php echo $row['IDNDung']; ?></th>
                        ...
                        <img src="<?php echo $row['anh']; ?>" alt="Ảnh giảng viên" style="width: 50px; height: auto;">
                        </td>
                        ...
                        <td class="text-center">
                          <a href="SuaGV.php?this_id=<?php echo $row['IDNDung']; ?>" class="btn btn-primary btn-sm" title="Sửa menu">
                            <i class="bi bi-pencil"></i>
                          </a>
                          <a href="XoaGV.php?this_id=<?php echo $row['IDNDung']; ?>" class="btn btn-danger btn-sm" title="Xóa menu">
